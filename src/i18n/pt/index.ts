...
const pt = {
  ...
  guide:
    "Arraste para mover, role ou belisque para ampliar/reduzir, clique duas vezes para redefinir.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        ...
        description:
          "Define a altura de cada página dividida em pixels. O padrão é 1000px.",
      },
      overlap: {
        label: "Sobreposição",
        description:
          "Define a sobreposição entre páginas para evitar cortes abruptos de conteúdo. O padrão é 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Se ativado, o processo de configuração será ignorado ao exportar notas selecionadas, e a imagem exportada será copiada diretamente para a área de transferência.",
    },
    userInfo: {
  ...
  splitInfo:
    "A altura total da imagem é {rootHeight}px, e a altura de divisão é {splitHeight}px, portanto, serão geradas {pages} imagens",
  splitInfoHr:
    "A altura total da imagem é {rootHeight}px, e a altura de divisão é {splitHeight}px, portanto, serão geradas {pages} imagens",

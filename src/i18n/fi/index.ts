...
const fi = {
  ...
  guide:
    "Raahaa liikuttaaksesi, vieritä tai nipistä zoomataksesi, kaksoisnapsauta nollataksesi.",
  ...
  setting: {
    ...
    imageWidth: {
      ...
      description: "Aseta vietävän kuvan leveys pikseleinä. Oletus on 640px.",
    },
    split: {
      title: "Jaa kuva",
      mode: {
      ...
      height: {
        ...
        description:
          "Aseta kunkin jaetun kuvan korkeus pikseleinä. Oletus on 1000px.",
      },
      overlap: {
        label: "Jaettujen kuvien päällekkäisyys",
        description:
          "Aseta vierekkäisten jaettujen kuvien päällekkäisyys pikseleinä, jotta sisältö ei katkea. Oletus on 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Jos käytössä, määritysprosessi ohitetaan valittujen muistiinpanojen viennissä, ja vietävä kuva kopioidaan suoraan leikepöydälle.",
    },
    userInfo: {
  ...
  imageUrl: "Syötä URL",
  splitInfo:
    "Kuvan kokonaiskorkeus on {rootHeight}px, ja jakokorkeus on {splitHeight}px, joten {pages} kuvaa luodaan",
  splitInfoHr:
    "Kuvan kokonaiskorkeus on {rootHeight}px, ja jakokorkeus on {splitHeight}px, joten {pages} kuvaa luodaan",

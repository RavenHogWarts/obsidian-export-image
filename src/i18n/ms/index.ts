...
const ms = {
  ...
  guide:
    "Seret untuk Bergerak, gulir atau cubit untuk zoom masuk/keluar, klik dua kali untuk menetapkan semula.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        ...
        description:
          "Tetapkan tinggi setiap halaman yang dibahagikan dalam piksel. Lalai adalah 1000px.",
      },
      overlap: {
        label: "Overlapping",
        description:

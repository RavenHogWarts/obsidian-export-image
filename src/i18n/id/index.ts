...
const id = {
  ...
  save: "Simpan Gambar",
  saveSuccess:
    "Gambar berhasil diekspor dan disimpan sebagai {filePath: string}.",
  ...
  guide:
    "Seret untuk Bergerak, gulir atau cubit untuk memperbesar/memperkecil, klik dua kali untuk mereset.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        ...
        description:
          "Setel tinggi setiap halaman yang dibahagikan dalam piksel. Default adalah 1000px.",
      },
      overlap: {
        label: "Overlapping",
        description:
          "Setel overlapping antara halaman untuk menghindari konten yang terputus secara tiba-tiba. Default adalah 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      label: "Ekspor cepat",
      description:
        "Jika diaktifkan, proses konfigurasi akan diabaikan saat mengekspor catatan yang dipilih, dan gambar yang diekspor akan langsung disalin ke clipboard.",
    },
    userInfo: {
      title: "Info Penulis",
  ...
  splitInfo:
    "Tinggi gambar keseluruhan adalah {rootHeight}px, dan tinggi pemotongan adalah {splitHeight}px, jadi akan dihasilkan {pages} gambar",
  splitInfoHr:
    "Tinggi gambar keseluruhan adalah {rootHeight}px, dan tinggi pemotongan adalah {splitHeight}px, jadi akan dihasilkan {pages} gambar",

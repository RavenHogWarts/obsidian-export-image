...
const hu = {
  ...
  guide:
    "Húzással mozgatható, görgetéssel vagy csipetmozdulattal zoomolható, dupla kattintással visszaállítható.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        ...
        description:
          "Állítsd be az egyes felosztott képek magasságát pixelben. Az alapértelmezett érték 1000px.",
      },
      overlap: {
        label: "Felosztott képek átfedése",
        description:
          "Állítsd be a szomszédos felosztott képek átfedését pixelben, hogy elkerüld a tartalom levágását. Az alapértelmezett érték 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Ha engedélyezve van, a konfigurációs folyamat figyelmen kívül lesz hagyva, amikor kiválasztott jegyzetek exportálásra kerülnek, és az exportált kép közvetlenül a vágólapra másolódik.",
    },
    userInfo: {
  ...
  imageUrl: "Kép URL",
  splitInfo:
    "A kép teljes magassága {rootHeight}px, és a felosztás magassága {splitHeight}px, így {pages} kép lesz generálva.",
  splitInfoHr:
    "A kép teljes magassága {rootHeight}px, és a felosztás magassága {splitHeight}px, így {pages} kép lesz generálva.",

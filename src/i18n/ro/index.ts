...
const ro = {
  ...
  guide:
    "Trageți pentru a muta, derulați sau ciupiți pentru zoom, faceți dublu clic pentru a reseta.",
  ...
  setting: {
    ...
    split: {
      ...
      mode: {
        ...
        description:
          "Alegeți modul de divizare a imaginii, în funcție de nevoile dumneavoastră.",
        none: "Niciun mod",
        fixed: "Mod fix",
    ...
    quickExportSelection: {
      ...
      description:
        "Dacă este activat, se va omite procesul de configurare atunci când se exportă notele selectate, iar imaginea exportată se va copia direct în clipboard.",
    },
    userInfo: {
    ...
    watermark: {
      ...
      opacity:
        "Opacitatea filigranului (0 este transparent, 1 nu este transparent)",
  ...
  splitInfo:
    "Înălțimea totală a imaginii este {rootHeight}px, iar înălțimea de divizare este {splitHeight}px, deci vor fi create {pages} imagini",
  splitInfoHr:
    "Înălțimea totală a imaginii este {rootHeight}px, iar înălțimea de divizare este {splitHeight}px, deci vor fi create {pages} imagini",

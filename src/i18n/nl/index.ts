...
const nl = {
  ...
  guide:
    "Sleep om te bewegen, scroll of knijp om in/uit te zoomen, dubbelklik om te resetten.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        ...
        description:
          "Stel de hoogte van elke pagina in pixels in. De standaard is 1000px.",
      },
      overlap: {
        label: "Overlapping",
        description:
          "Sett overlapp mellom sider for å unngå brutt innhold. Standard er 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Als ingeschakeld, wordt de configuratieproces overgeslagen bij het exporteren van geselecteerde notities, en het geëxporteerde beeld wordt direct naar het klembord gekopieerd.",
    },
    userInfo: {
    ...
    watermark: {
      ...
      opacity:
        "Doorzichtigheid van watermerk (0 is transparant, 1 is niet transparant)",
  ...
  splitInfo:
    "De totale hoogte van de afbeelding is {rootHeight}px, en de hoogte van de splitsing is {splitHeight}px, dus er zullen {pages} afbeeldingen worden gemaakt",
  splitInfoHr:
    "De totale hoogte van de afbeelding is {rootHeight}px, en de hoogte van de splitsing is {splitHeight}px, dus er zullen {pages} afbeeldingen worden gemaakt",

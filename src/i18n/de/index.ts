...
const de = {
  ...
  guide:
    "Ziehen zum Bewegen, scrollen oder kneifen zum Zoomen, Doppelklick zum Zurücksetzen.",
  ...
  setting: {
    ...
    padding: {
      title: "Bildrand",
      description:
        "Stellen Sie den Innenabstand für das exportierte Bild ein. Der Standardwert beträgt 6px für alle Seiten.",
      top: "Oberer Abstand",
    ...
    split: {
      ...
      height: {
        label: "Seitenhöhe",
        description:
          "Legt die Höhe jeder geteilten Seite in Pixeln fest. Standard ist 1000px.",
      },
      overlap: {
        label: "Überlappungsabstand",
        description:
          "Legt den Überlappungsabstand zwischen den Seiten fest, um abrupte Inhaltsabschnitte zu vermeiden. Standard ist 40px.",
      },
    },
    filename: {
    ...
    resolutionMode: {
      ...
      description:
        "Setzen Sie den Auflösungsmodus, verwenden Sie Bilder mit 1x, 2x, 3x, 4x Auflösung. Wenn aktiviert, erscheinen Bilder schärfer, mit einer besseren Erfahrung auf hochauflösenden Bildschirmen wie Smartphones. Der Nachteil ist, dass die Bilddateigröße zunimmt.",
    },
    metadata: {
    ...
    quickExportSelection: {
      ...
      description:
        "Wenn aktiviert, wird der Konfigurationsprozess übersprungen, wenn Sie ausgewählte Notizen exportieren, und das exportierte Bild wird direkt in die Zwischenablage kopiert.",
    },
    userInfo: {
      title: "Autoreninfo",
    ...
    watermark: {
      ...
      type: {
        ...
        description:
          "Legen Sie den Typ des Wasserzeichens fest, Text oder Bild.",
        text: "Text",
        image: "Bild",
      },
      text: {
      ...
      opacity:
        "Wasserzeichen-Durchsichtigkeit (0 ist transparent, 1 ist nicht transparent)",
    ...
    customCSS: {
      ...
      enable: {
        ...
        description:
          "CSS aktivieren, unterstützt CSS aus aktuellem Tresor auswählen.",
      },
      src: {
        label: "CSS-Ordner",
      ...
      css: {
        label: "CSS",
        description:
          "CSS-Datei auswählen. CSS-Selektor sollte mit .export-image-root beginnen, um die korrekte Scope zu gewährleisten.",
  ...
  splitInfo:
    "Die Gesamthöhe des Bildes beträgt {rootHeight}px, und die Höhe der Aufteilung beträgt {splitHeight}px, sodass {pages} Bilder generiert werden.",
  splitInfoHr:
    "Die Gesamthöhe des Bildes beträgt {rootHeight}px, und die Höhe der Aufteilung beträgt {splitHeight}px, sodass {pages} Bilder generiert werden.",

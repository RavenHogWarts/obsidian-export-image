...
const cs = {
  ...
  guide:
    "Tažením přesuňte, posouváním nebo špetkou zvětšte/zmenšte, dvojím kliknutím resetujte.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        label: "Výška stránky",
        description:
          "Nastaví výšku každé rozdělené stránky v pixelech. Výchozí je 1000px.",
      },
      overlap: {
        label: "Překrytí",
        description:
          "Nastaví překrytí mezi stránkami, aby se zabránilo náhlému přerušení obsahu. Výchozí je 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Pokud je povoleno, při exportu výběru se přeskočí konfigurační proces a exportovaný obrázek se přímo zkopíruje do schránky.",
    },
    userInfo: {
    ...
    watermark: {
      ...
      enable: {
        ...
        description: "Povolit vodoznak, podporuje textový a obrazový vodoznak.",
      },
      type: {
        label: "Typ vodoznaku",
  ...
  splitInfo:
    "Celková výška obrázku je {rootHeight}px, a výška dělení je {splitHeight}px, takže se vygeneruje {pages} obrázků",
  splitInfoHr:
    "Celková výška obrázku je {rootHeight}px, a výška dělení je {splitHeight}px, takže se vygeneruje {pages} obrázků",

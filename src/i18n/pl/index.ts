...
const pl = {
  ...
  save: "Zapisz obraz",
  saveSuccess:
    "Obraz został wyeksportowany i zapisany jako {filePath: string}.",
  ...
  guide:
    "Przeciągnij, aby przesunąć, przewiń lub zaciśnij, aby przybliżyć/oddalić, podwójne kliknięcie, aby zresetować.",
  ...
  setting: {
    ...
    split: {
      ...
      mode: {
        label: "Tryb podziału",
        description:
          "Wybierz sposób podziału obrazu, w tym wysokość strony, przekrywanie między stronami i tryb podziału.",
        none: "Brak podziału",
      ...
      height: {
        ...
        description:
          "Ustawia wysokość każdej strony podzielonej w pikselach. Domyślnie jest 1000px.",
      },
      overlap: {
        label: "Przekrywanie",
        description:
          "Ustawia przekrywanie między stronami, aby uniknąć nagłego przerwania treści. Domyślnie jest 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Jeśli jest włączony, pominięty zostanie proces konfiguracji podczas eksportowania wybranych notatek, a eksportowane obrazy zostaną bezpośrednio skopiowane do schowka.",
    },
    userInfo: {
    ...
    watermark: {
      ...
      opacity:
        "Przezroczystość znaku wodnego (0 jest przezroczysty, 1 nieprzezroczysty)",
  ...
  imageUrl: "URL obrazu",
  splitInfo:
    "Wysokość całego obrazu to {rootHeight}px, a wysokość podziału to {splitHeight}px, więc zostanie wygenerowanych {pages} obrazów",
  splitInfoHr:
    "Wysokość całego obrazu to {rootHeight}px, a wysokość podziału to {splitHeight}px, więc zostanie wygenerowanych {pages} obrazów",

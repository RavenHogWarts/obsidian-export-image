...
const it = {
  ...
  moreSetting:
    "Ulteriori impostazioni si trovano nelle impostazioni del plugin `Export Image`.",
  guide:
    "Trascina per muovere, scorri o pizzica per ingrandire/rimpicciolire, doppio clic per ripristinare.",
  ...
  setting: {
    ...
    padding: {
      ...
      description:
        "Imposta il padding per l'immagine esportata. Il valore predefinito è 6px per tutti i lati.",
    ...
    imageWidth: {
      ...
      description:
        "Imposta la larghezza dell'immagine esportata, il valore predefinito è 640px.",
    },
    split: {
      ...
      height: {
        ...
        description:
          "Imposta l'altezza di ogni immagine divisa (in pixel). Il valore predefinito è 1000px.",
      },
      overlap: {
        label: "Sovrapposizione immagini divise",
        description:
          "Imposta la sovrapposizione (in pixel) tra due immagini divise adiacenti per evitare che il contenuto venga tagliato. Il valore predefinito è 40px.",
      },
    },
    filename: {
      label: "Modalità visualizzazione titolo",
      description:
        "Imposta come visualizzare il titolo. Puoi scegliere di nasconderlo, inserire uno personalizzato durante l'esportazione, o leggerlo da una proprietà frontmatter.",
      none: "Nascondi",
      custom: "Personalizzato",
      frontmatter: "Usa proprietà frontmatter",
      frontmatterProperty: "Nome proprietà frontmatter",
      frontmatterPropertyDesc:
        "Specifica il nome della proprietà frontmatter per ottenere il titolo, come title, name, ecc.",
      customTitle: "Titolo personalizzato",
      customTitlePlaceholder: "Inserisci il titolo personalizzato",
    },
    resolutionMode: {
      label: "Immagine in modalità risoluzione",
      description:
        "Imposta la modalità risoluzione, utilizzando immagini con risoluzione 1x, 2x, 3x, 4x. Quando abilitato, le immagini appariranno più nitide, con una migliore esperienza su schermi ad alto PPI come gli smartphone. Lo svantaggio è che la dimensione del file dell'immagine aumenterà.",
    },
    metadata: {
    ...
    quickExportSelection: {
      ...
      description:
        "Se saltare il processo di configurazione durante l'esportazione della selezione e copiare direttamente l'immagine esportata negli appunti.",
    },
    userInfo: {
    ...
    watermark: {
      ...
      enable: {
        ...
        description:
          "Abilita la filigrana, supporta filigrana di testo e immagine.",
      },
      type: {
    ...
    customCSS: {
      ...
      enable: {
        label: "Abilita CSS",
        description:
          "Abilita CSS, supporta selezione CSS dal repository corrente.",
      },
      src: {
        label: "Cartella CSS",
      ...
      css: {
        label: "CSS",
        description:
          "Imposta il CSS da caricare. Seleziona un selettore CSS con .export-image-root per assicurare lo scope corretto.",
  ...
  splitInfo:
    "L'altezza totale dell'immagine è {rootHeight}px, e l'altezza di divisione è {splitHeight}px, quindi verranno generate {pages} immagini",
  splitInfoHr:
    "L'altezza totale dell'immagine è {rootHeight}px, e l'immagine verrà divisa dalla linea orizzontale, quindi verranno generate {pages} immagini",

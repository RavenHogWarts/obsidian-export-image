...
const fr = {
  ...
  guide:
    "Faites glisser pour déplacer, faites défiler ou pincez pour zoomer, double-cliquez pour réinitialiser.",
  ...
  setting: {
    ...
    padding: {
      title: "Marge d'image",
      description:
        "Définissez le rembourrage pour l'image exportée. La valeur par défaut est de 6px pour tous les côtés.",
    ...
    split: {
      ...
      height: {
        ...
        description:
          "Définit la hauteur de chaque page fractionnée en pixels. La valeur par défaut est 1000px.",
      },
      overlap: {
        label: "Chevauchement",
        description:
          "Définit le chevauchement entre les pages pour éviter les coupures brusques de contenu. La valeur par défaut est 40px.",
      },
    },
    filename: {
    ...
    resolutionMode: {
      ...
      description:
        "Définissez le mode résolution, en utilisant des images avec une résolution 1x, 2x, 3x, 4x. Lorsqu'il est activé, les images apparaîtront plus nettes, avec une meilleure expérience sur les écrans à haute PPI comme les smartphones. L'inconvénient est que la taille du fichier de l'image augmentera.",
    },
    metadata: {
    ...
    quickExportSelection: {
      ...
      description:
        "Si activé, le processus de configuration est ignoré lors de l'exportation de notes sélectionnées, et l'image exportée est directement copiée dans le presse-papiers.",
    },
    userInfo: {
      title: "Info auteur",
    ...
    watermark: {
      ...
      opacity:
        "Opacité du filigrane (0 est transparent, 1 n'est pas transparent)",
    ...
    customCSS: {
      ...
      enable: {
        label: "Activer CSS",
        description:
          "Activer CSS, supporte la sélection de CSS depuis le dépôt actuel.",
      },
      src: {
        label: "Dossier CSS",
      ...
      css: {
        label: "CSS",
        description:
          "Définissez le CSS à charger. Sélectionnez un sélecteur CSS avec .export-image-root pour assurer le bon scope.",
  ...
  splitInfo:
    "La hauteur totale de l'image est de {rootHeight}px, et la hauteur de division est de {splitHeight}px, donc {pages} images seront générées.",
  splitInfoHr:
    "La hauteur totale de l'image est de {rootHeight}px, et la hauteur de division est de {splitHeight}px, donc {pages} images seront générées.",

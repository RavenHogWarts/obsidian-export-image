...
const no = {
  ...
  guide:
    "Dra for å flytte, rull eller knip for å zoome inn/ut, dobbeltklikk for å tilbakestille.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        label: "Høyde på side",
        description:
          "Sett høyden på hver side delt i piksler. Standard er 1000px.",
      },
      overlap: {
        label: "Overlapping",
        description:
    ...
    quickExportSelection: {
      ...
      description:
        "Hvis aktiv, springes konfigurasjonsprosessen over, når du eksporterer valgte noter, og eksporteret bilde kopieres direkte til utklippstavlen.",
    },
    userInfo: {
    ...
    watermark: {
      ...
      enable: {
        ...
        description: "Aktiver vannmerke, støtter tekst- og bildevannmerker.",
      },
      type: {
      ...
      opacity:
        "Vannmerkets opasitet (0 er gjennomsiktig, 1 er ikke gjennomsiktig)",
  ...
  imageUrl: "Bilde-URL",
  splitInfo:
    "Total bildehøyde er {rootHeight}px, og delingshøyde er {splitHeight}px, så det vil bli generert {pages} bilder",
  splitInfoHr:
    "Total bildehøyde er {rootHeight}px, og delingshøyde er {splitHeight}px, så det vil bli generert {pages} bilder",

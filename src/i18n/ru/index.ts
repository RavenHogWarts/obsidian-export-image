...
const ru = {
  ...
  guide:
    "Перетаскивайте для перемещения, прокручивайте или сжимайте для масштабирования, дважды щелкните для сброса.",
  ...
  setting: {
    ...
    split: {
      ...
      mode: {
        ...
        description:
          "Выберите способ разделения изображения, в том числе высоту страницы, перекрытие между страницами и режим разделения.",
        none: "Нет разделения",
    ...
    quickExportSelection: {
      ...
      description:
        "Если включено, процесс настройки будет пропущен при экспорте выбранных заметок, и экспортированное изображение будет скопировано непосредственно в буфер обмена.",
    },
    userInfo: {
  ...
  splitInfo:
    "Общая высота изображения составляет {rootHeight}px, а высота разделения составляет {splitHeight}px, поэтому будет создано {pages} изображений",
  splitInfoHr:
    "Общая высота изображения составляет {rootHeight}px, и высота разделения составляет {splitHeight}px, поэтому будет создано {pages} изображений",

...
const da = {
  ...
  guide:
    "Træk for at flytte, scroll eller knib for at zoome ind/ud, dobbeltklik for at nulstille.",
  ...
  setting: {
    ...
    split: {
      ...
      height: {
        label: "Sidehøjde",
        description:
          "Indstiller højden af hver delt side i pixels. Standard er 1000px.",
      },
      overlap: {
        label: "Overlap",
        description:
          "Indstiller overlappet mellem sider for at undgå brat afbrydelse af indhold. Standard er 40px.",
      },
    },
    filename: {
    ...
    quickExportSelection: {
      ...
      description:
        "Hvis aktiveret, springes konfigurationsprocessen over, når du eksporterer valgte noter, og eksporteret billede kopieres direkte til udklipsholderen.",
    },
    userInfo: {
      title: "Forfatterinfo",
  ...
  splitInfo:
    "Den totale højde af billedet er {rootHeight}px, og delingshøjden er {splitHeight}px, så der vil blive genereret {pages} billeder",
  splitInfoHr:
    "Den totale højde af billedet er {rootHeight}px, og delingshøjden er {splitHeight}px, så der vil blive genereret {pages} billeder",
